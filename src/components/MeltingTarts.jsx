...
/* Banner de tartas derritiéndose */
  ...
  return (
    <div style={{ flex: '0 0 90px', position: 'relative', width: 90, height: 140 }}>
      <svg viewBox="0 0 100 150" width="100%" height="100%" style={{ overflow: 'visible' }}>
        ...
        {/* Cuerpo cremoso — se derrite */}
        <path
          style={{ animation: `${animName} 3.2s ease-in-out ${delay}s infinite` }}
        ...
        <text x="50" y="72" textAnchor="middle"
          fontFamily="Cinzel, serif" fontWeight="700" fontSize="11" fill="#8A5A2B" opacity="0.55">V</text>
      </svg>
      <style>{`
        @keyframes ${animName} {
          0%,100% { d: path("M 10 70 Q 10 76, 20 78 L 30 78 Q 35 82, 40 78 L 55 78 Q 60 82, 65 78 L 80 78 Q 90 76, 90 70 Q 90 60, 50 58 Q 10 60, 10 70 Z") }
          50%      { d: path("M 10 70 Q 10 82, 22 92 L 30 96 Q 35 104, 40 100 L 55 102 Q 60 108, 65 100 L 80 96 Q 90 84, 90 70 Q 90 60, 50 58 Q 10 60, 10 70 Z") }
        }
      `}</style>
    </div>
  );
