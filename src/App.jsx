...
import { Favorites, RollingCoins, Menu, Pack, TartOfMonth, Special, Contact, Footer } from './components/Sections';
...
const SECTIONS = [
  ...
  { id: 'pack',       numeral: 'V',    label: 'Pack degustación', hint: 'tres pequeñas a elegir' },
